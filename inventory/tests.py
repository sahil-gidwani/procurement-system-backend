...
class InventoryModelsTestCase(TestCase):
    ...
    def test_create_historical_inventory_on_create(self):
        ...
        historical_inventory_item = HistoricalInventory.objects.get(inventory=inventory_item)
        self.assertEqual(historical_inventory_item.stock_quantity, inventory_item.stock_quantity)
        self.assertEqual(historical_inventory_item.date, inventory_item.date_added.date())
    ...
    def test_create_historical_inventory_on_update(self):
        ...
        historical_inventory_items = HistoricalInventory.objects.filter(inventory=inventory_item)
    ...
    def test_delete_historical_inventory_on_inventory_delete(self):
        ...
        with self.assertRaises(ObjectDoesNotExist):
            ...
            historical_inventory_items_after_delete = HistoricalInventory.objects.filter(inventory=inventory_item)
...
class InventoryViewsTestCase(TestCase):
    ...
    def test_historical_inventory_list_view_procurement_officer(self):
        ...
        url = reverse('historical_inventory_list', kwargs={'inventory_id': inventory_item.id})
        self.client.force_authenticate(user=self.procurement_officer)
        response = self.client.get(url)
    ...
    def test_historical_inventory_list_view_procurement_officer_invalid_inventory_id(self):
